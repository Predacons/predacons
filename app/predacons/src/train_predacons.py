...
class TrainPredacons:
    ...
    def __trainer(*args,**kwargs):
        ...
        print("loading model and tokenizer new approach")
        model_name = ""
        model = None
        tokenizer = None
        ...
        if train_file_path != None and train_dataset == None:
            ...
            print(f"train_file_type: {train_file_type}")
            print(f"!!!!in file path approach")
    ...
    def create_auto_formatting_func(train_dataset):
        feature_list  = []
        for feature in  list(train_dataset['train'].features):
            print(feature)
            if feature == 'input_ids' or feature == 'attention_mask':
                continue
            else:
                feature_list.append(feature)
    ...
    def __trainer(*args,**kwargs):
        ...
        formatting_func = kwargs.get('formatting_func',None)
        if formatting_func == None:
            print("automatically creating formating function for the dataset")
            # try:
            #     formatting_func = TrainPredacons.create_auto_formatting_func(train_dataset)
            # except:
            #     print("failed to generate auto formating function. using default formating function. may impact training")
            formatting_func = TrainPredacons.formatting_func
